	...
	public static void main(String[] args) {
		...
		Runnable runner = new Runnable(){
			...
			public void run() {
				...
				ArtificialHorizonPanel leftPanel = new ArtificialHorizonPanel("kalman");
				ArtificialHorizonPanel rightPanel = new ArtificialHorizonPanel("sensor");
...
//				final SerialCommunicator serial = new SerialCommunicator(leftPanel, rightPanel, subPanel, centerPanel, upPanel);
				...
				portList = serial.getComPortAvailable();

				switch(serial.getComPortAvailable().size()){
				case 0:
				...
				ActionListener openComm = new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						serial.connect(baudRateValue, portChoosen);
					}
				};
